...
<head>
  ...
  <link href="<?php echo base_url('assets/css/style-about.css')?>" rel="stylesheet">
...
<body id="page-top">
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll" href="#page-top">UNJANI - KEL.3</a>
      ...
      <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll" href="#Layanan">Layanan</a>
          </li>
          <li class="nav-item">
